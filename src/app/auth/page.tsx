  ...
  return (
    <form className="space-y-7">
      ...
      <div className="flex justify-between items-center">
        <button
          type="button"
          className="text-[#3AF0C0] text-xs hover:underline"
          onClick={onForgot}
        >
          Forgot Password?
        </button>
      </div>
      <AccentButton>Sign In Now</AccentButton>
...
function SignupForm() {
  ...
  return (
    <form className="space-y-7">
      <FloatingInput label="Name" type="text" name="name" autoComplete="name" placeholder=" " />
      <FloatingInput label="Email" type="email" name="email" autoComplete="email" icon={<FiMail />} placeholder=" " />
      <FloatingInput label="Password" type="password" name="password" autoComplete="new-password" icon={<FiLock />} placeholder=" " />
  ...
  return (
    <form className="space-y-7">
      <FloatingInput
        ...
        placeholder=" "
      />
      <AccentButton>Send Reset Link</AccentButton>
      <div className="text-center text-[#A1A1A1] text-xs mt-2">
...
// Floating Label Input (Neumorphic + Glass)
